...
public class MoviesLab {
    ...
    public void actionGenerator(){
        ...
        Movie two = new Movie("Debt Collectors",3,2020,"A sequel to 2018's Walter Hill-like throwback The Debt Collector, which found the reliably bruising Scott Adkins playing a reluctant mob " +
        ...
        Movie three = new Movie("The Old Guard",4,2020,"After battling her way through an apocalyptic desert wasteland in Mad Max: Fury Road, punching her way" +
        ...
        Movie four = new Movie("Extraction",5,2020,"Tossing aside Thor's massive hammer and trimming his gnarly Avengers: Endgame beard, Chris Hemsworth picks up " +
        ...
        Movie five = new Movie("Blood on Her Name",4,2020,"At less than 90 minutes, this dread-soaked, Southern-fried neo-noir doesn't waste time turning the screws on" +
